-----SCRIPT ALTERS ALL DATABASES TO AUTOGROW IN MB
------TO CHANGE SIZE SEARCH <FILEGROWTH = 200MB>
...
BEGIN  
    ...
    SET @Query  = 'ALTER DATABASE '+ @name +' MODIFY FILE (NAME = '+@vFileName+',FILEGROWTH = 200MB)'  
    EXECUTE(@Query)  
