...
/****** Object:  Job [Temporary Elevation of Permissions]    Script Date: 07/12/2018 08:16:56 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 07/12/2018 08:16:56 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Temporary Elevation of Permissions', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [ADD Permissions]    Script Date: 07/12/2018 08:16:56 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [REMOVE Permissions]    Script Date: 07/12/2018 08:16:56 ******/
...
GO', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Mail]    Script Date: 07/12/2018 08:16:56 ******/
