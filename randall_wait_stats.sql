-- WAIT_STATS USE TO PERFORMANCE ISSUES
--------------------------------
PRINT 'CURRENTLY WAITING'
SELECT * FROM sys.dm_os_waiting_tasks
---------FILTER BENIGN WAITS FROM LIST
...
N'BROKER_TO_FLUSH',  N'BROKEREVENTHANDLER',
N'FT_IFTSHC_MUTEX',  N'SQLTRACE_INCREMENTAL_FLUSH_SLEEP',
N'DIRTY_PAGE_POLL')

--DBCC SQLPERF (N'sys.dm_os_wait_stats', CLEAR);
--CLEAR CACHE TO RESET WAITS IF REQUIRED
------------------------------------------------
GO
PRINT 'HISTORICAL WAITS'
GO
WITH [Waits]AS
(SELECT  
[wait_type],
...
CAST (([w1].[waits] /[w1].[waitcount]) AS DECIMAL (14,4)) AS [Avg_wait_s],
CAST (([w1].[resources] /[w1].[waitcount]) AS DECIMAL (14,4)) AS [Avg_resource_s],
CAST (([w1].[Signals] /[w1].[waitcount]) AS DECIMAL (14,4)) AS [Avg_sig_s]
  FROM [waits] AS [W1]
